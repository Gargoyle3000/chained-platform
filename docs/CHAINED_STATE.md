...
- Authenticated workspace pages now provide permanent user-invoked contextual `[ ? ]` help. One responsive panel uses route-specific THIS PAGE / EDIT HERE / CONNECTED TO copy for Dashboard, Works, Presentations, Agenda, Profile, CV, Press and Archive, including their distinct editors; it is non-navigational and never opens automatically.
