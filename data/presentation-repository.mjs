...
function createUnavailableRepository() {
  return Object.freeze({
    ...
    async getPresentationAgendaImageContext() { return { hasDedicatedImage: false, representativeWorkId: null, works: [] }; },
    async uploadPresentationAgendaImage() { throw new Error("AGENDA IMAGE IS CURRENTLY UNAVAILABLE"); },
    async removePresentationAgendaImage() { throw new Error("AGENDA IMAGE IS CURRENTLY UNAVAILABLE"); },
    async setPresentationRepresentativeWork() { throw new Error("AGENDA IMAGE IS CURRENTLY UNAVAILABLE"); },
