-- Align trusted invitation lifecycle expiry with the configured Auth invite window.

alter table public.account_invitations
  alter column expires_at
  set default statement_timestamp() + interval '24 hours';
...
begin
  ...
  new.expires_at := coalesce(new.expires_at, new.approved_at + interval '24 hours');
